...
namespace EjemploMVCConversor.Controllers
{
    public class PaisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CodigoPais,Descripcion")] Pais pais)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CodigoPais,Descripcion")] Pais pais)
        {
            if (id != pais.Id)
            {
                return NotFound();
